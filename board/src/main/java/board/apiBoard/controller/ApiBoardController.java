package board.apiBoard.controller;
...
public class ApiBoardController {
	...
	public ModelAndView openBoardList() throws Exception {
		ModelAndView mv = new ModelAndView("/apiBoard/list");
	...
	public ModelAndView openBoardDetail(@PathVariable int boardIdx) throws Exception {
		ModelAndView mv = new ModelAndView("/apiBoard/view");
	...
	//Delete File
	@DeleteMapping(value="/board/file")
